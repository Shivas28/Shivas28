...
shivas = {
    ...
    "education"  : "B.Tech CSE — Malla Reddy University, Hyderabad (2025)",
    "focus"      : ["Machine Learning", "Deep Learning", "NLP", "Data Analytics"],
    "tools"      : ["Python", "SQL", "Power BI", "Scikit-learn", "Pandas"],
    "certifications": [
        "AWS Cloud Foundations",
        "Salesforce Developer Internship (SmartInternz)",
...
| ☁️ | Cloud Computing Basics | Coursera |
| 📝 | B2 Empower Cambridge English | Cambridge Assessment |
